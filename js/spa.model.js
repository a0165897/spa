...
spa.model = (function(){
    ...
    var configMap = { anon_id : 'a0'},
        ...
        isFakeData = true,
        chat,personProto, makeCid,clearPeopleDb,completeLogin,makePerson,removePerson, people, initModule;
    ...
    chat = (function () {
      var _publish_listchange,_update_list,_leave_chat,join_chat,_publish_updatechat,
          person,update_avatar,get_chatee,send_msg,set_chatee,chatee = null;
